...
{
    Console.WriteLine("""
    starktrace-pack — StarkTrace Pack Tool
...
int NewPack(string[] args)
{
    if (args.Length < 4)
    {
        Console.Error.WriteLine("Usage: starktrace-pack new <pack-id> <name> <project> [-o output.json]");
        return 1;
    }
...
int Validate(string[] args)
{
    if (args.Length < 2)
    {
        Console.Error.WriteLine("Usage: starktrace-pack validate <file.json>");
        return 1;
    }
