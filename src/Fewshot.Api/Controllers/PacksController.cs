...
public class PacksController : ControllerBase
{
    ...
    /// <summary>
    /// Export a project's knowledge as an unencrypted FewshotPack JSON.
    /// </summary>
    [HttpGet("export/{project}")]
    public async Task<ActionResult<FewshotPack>> Export(string project, [FromQuery] string? author = null)
    {
    ...
    /// <summary>
    /// Export and encrypt a project's knowledge as an .fewshotpack envelope.
    /// </summary>
    ...
    /// <summary>
    /// Import an unencrypted FewshotPack JSON into Fewshot.
    /// </summary>
    [HttpPost("import")]
