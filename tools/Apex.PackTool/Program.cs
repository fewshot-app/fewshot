...
{
    Console.WriteLine("""
    apex-pack — APEX Pack Tool

    Usage:
      apex-pack new <pack-id> <name> <project> [-o output.json]
      apex-pack validate <file.json>
      apex-pack encrypt <file.json> --key <base64-key> [-o output.apexpack]
      apex-pack decrypt <file.apexpack> --key <base64-key> [-o output.json]
      apex-pack keygen
      apex-pack machine-id
...
int NewPack(string[] args)
{
    if (args.Length < 4)
    {
        Console.Error.WriteLine("Usage: apex-pack new <pack-id> <name> <project> [-o output.json]");
        return 1;
    }
...
int Validate(string[] args)
{
    if (args.Length < 2)
    {
        Console.Error.WriteLine("Usage: apex-pack validate <file.json>");
        return 1;
    }
...
int Encrypt(string[] args)
{
    if (args.Length < 2)
    {
        Console.Error.WriteLine("Usage: apex-pack encrypt <file.json> --key <base64-key> [-o output.apexpack]");
        return 1;
    }
...
int Decrypt(string[] args)
{
    if (args.Length < 2)
    {
        Console.Error.WriteLine("Usage: apex-pack decrypt <file.apexpack> --key <base64-key> [-o output.json]");
        return 1;
    }
