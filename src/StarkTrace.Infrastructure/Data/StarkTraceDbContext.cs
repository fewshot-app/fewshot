...
namespace StarkTrace.Infrastructure.Data;

public class StarkTraceDbContext : DbContext
{
    public StarkTraceDbContext(DbContextOptions<StarkTraceDbContext> options) : base(options) { }
    ...
    protected override void OnModelCreating(ModelBuilder m)
    {
        ...
        // ProxyAuditLog — events from StarkTrace.Proxy stdio interceptor
