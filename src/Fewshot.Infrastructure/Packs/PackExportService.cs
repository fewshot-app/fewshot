...
/// <summary>
/// Exports a project's memories, preferences, and anti-patterns as an FewshotPack.
/// </summary>
public class PackExportService
{
    ...
    public PackExportService(FewshotDbContext db, ILogger<PackExportService> log)
    {
        _db = db;
        _log = log;
    }
    ...
    /// <summary>
    /// Export all knowledge for a project as an unencrypted FewshotPack.
    /// </summary>
    public async Task<FewshotPack?> ExportAsync(string projectName, string? author = null)
    {
        ...
        var pack = new FewshotPack
        {
            ...
            Description = $"Exported from Fewshot — {memories.Count} memories, {preferences.Count} preferences, {antiPatterns.Count} anti-patterns",
            Version = "1.0.0",
