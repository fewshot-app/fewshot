...
public static class PackCrypto
{
    ...
    /// <summary>
    /// Encrypt an StarkTracePack into an EncryptedPackEnvelope.
    /// </summary>
    public static EncryptedPackEnvelope Encrypt(StarkTracePack pack, string base64Key)
    {
    ...
    /// <summary>
    /// Decrypt an EncryptedPackEnvelope back to an StarkTracePack.
    /// Validates SHA256 integrity hash.
    /// </summary>
    public static StarkTracePack Decrypt(EncryptedPackEnvelope envelope, string base64Key)
    {
        var key = Convert.FromBase64String(base64Key);
        ...
        var pack = JsonSerializer.Deserialize<StarkTracePack>(plaintextBytes, _json)
    ...
    /// <summary>
    /// Serialize an StarkTracePack to unencrypted JSON (for export/validation).
    /// </summary>
    public static string SerializePack(StarkTracePack pack) =>
        JsonSerializer.Serialize(pack, _json);

    /// <summary>
    /// Deserialize an StarkTracePack from unencrypted JSON.
    /// </summary>
    public static StarkTracePack DeserializePack(string json) =>
        JsonSerializer.Deserialize<StarkTracePack>(json, _json)
