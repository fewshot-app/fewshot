...
namespace StarkTrace.Infrastructure.Experiments;
...
public class ExperimentService : IExperimentService
{
    ...
    public ExperimentService(StarkTraceDbContext db, IMessageService messages, ISuggestionService suggestions, IOutcomeService outcomes)
    {
        _db = db;
        _messages = messages;
