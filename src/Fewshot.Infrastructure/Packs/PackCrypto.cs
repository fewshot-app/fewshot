...
namespace Fewshot.Infrastructure.Packs;

/// <summary>
/// AES-256-CBC encryption/decryption for .fewshotpack files.
...
public static class PackCrypto
{
    ...
    /// <summary>
    /// Encrypt an FewshotPack into an EncryptedPackEnvelope.
    /// </summary>
    public static EncryptedPackEnvelope Encrypt(FewshotPack pack, string base64Key)
    {
    ...
    /// <summary>
    /// Decrypt an EncryptedPackEnvelope back to an FewshotPack.
    /// Validates SHA256 integrity hash.
    /// </summary>
    public static FewshotPack Decrypt(EncryptedPackEnvelope envelope, string base64Key)
    {
        var key = Convert.FromBase64String(base64Key);
        ...
        var pack = JsonSerializer.Deserialize<FewshotPack>(plaintextBytes, _json)
    ...
    /// <summary>
    /// Serialize an FewshotPack to unencrypted JSON (for export/validation).
    /// </summary>
    public static string SerializePack(FewshotPack pack) =>
        JsonSerializer.Serialize(pack, _json);

    /// <summary>
    /// Deserialize an FewshotPack from unencrypted JSON.
    /// </summary>
    public static FewshotPack DeserializePack(string json) =>
        JsonSerializer.Deserialize<FewshotPack>(json, _json)
