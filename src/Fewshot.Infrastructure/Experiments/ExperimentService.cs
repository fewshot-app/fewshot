...
namespace Fewshot.Infrastructure.Experiments;
...
public class ExperimentService : IExperimentService
{
    ...
    public ExperimentService(FewshotDbContext db, IMessageService messages, ISuggestionService suggestions, IOutcomeService outcomes)
    {
        _db = db;
        _messages = messages;
