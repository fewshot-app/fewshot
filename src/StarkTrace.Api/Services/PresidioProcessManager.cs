...
namespace StarkTrace.Api.Services;
...
public class PresidioProcessManager : IHostedService, IAsyncDisposable
{
    ...
    private void ResolvePaths()
    {
        ...
        var configScript = _configuration["StarkTrace:Presidio:ScriptPath"];
        var configPython = _configuration["StarkTrace:Presidio:PythonPath"];
