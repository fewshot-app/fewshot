...
public class PackImportService
{
    ...
    public PackImportService(StarkTraceDbContext db, IMemoryService memory, ILogger<PackImportService> log)
    {
        _db = db;
        _memory = memory;
        _log = log;
    ...
    /// <summary>
    /// Import from unencrypted StarkTracePack JSON (local export or dev use).
    /// </summary>
    ...
    /// </summary>
    private async Task<PackImportResult> ImportPackAsync(StarkTracePack pack, string? targetProject)
    {
