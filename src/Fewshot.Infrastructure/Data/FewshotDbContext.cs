...
namespace Fewshot.Infrastructure.Data;

public class FewshotDbContext : DbContext
{
    public FewshotDbContext(DbContextOptions<FewshotDbContext> options) : base(options) { }
